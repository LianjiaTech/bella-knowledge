...
public class Keys {
    ...
    public static final UniqueKey<FileEntryRecord> KEY_FILE_ENTRY_PRIMARY = Internal.createUniqueKey(FileEntry.FILE_ENTRY, DSL.name("KEY_file_entry_PRIMARY"), new TableField[] { FileEntry.FILE_ENTRY.ID }, true);
    public static final UniqueKey<FileEntryRecord> KEY_FILE_ENTRY_UK_SPACE_ENTRY = Internal.createUniqueKey(FileEntry.FILE_ENTRY, DSL.name("KEY_file_entry_uk_space_entry"), new TableField[] { FileEntry.FILE_ENTRY.SPACE_CODE, FileEntry.FILE_ENTRY.ENTRY_ID }, true);
    public static final UniqueKey<FileEntryRecord> KEY_FILE_ENTRY_UK_SPACE_FILE = Internal.createUniqueKey(FileEntry.FILE_ENTRY, DSL.name("KEY_file_entry_uk_space_file"), new TableField[] { FileEntry.FILE_ENTRY.SPACE_CODE, FileEntry.FILE_ENTRY.FILE_ID }, true);
    public static final UniqueKey<FileEntryRecord> KEY_FILE_ENTRY_UK_SPACE_PARENT_NAME = Internal.createUniqueKey(FileEntry.FILE_ENTRY, DSL.name("KEY_file_entry_uk_space_parent_name"), new TableField[] { FileEntry.FILE_ENTRY.SPACE_CODE, FileEntry.FILE_ENTRY.PARENT_ENTRY_ID, FileEntry.FILE_ENTRY.FILENAME }, true);
