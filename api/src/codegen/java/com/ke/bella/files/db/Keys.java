...
public class Keys {
    ...
    public static final UniqueKey<FileEntryRecord> KEY_FILE_ENTRY_UK_SPACE_PARENT_NAME_ACTIVE = Internal.createUniqueKey(FileEntry.FILE_ENTRY, DSL.name("KEY_file_entry_uk_space_parent_name_active"), new TableField[] { FileEntry.FILE_ENTRY.SPACE_CODE, FileEntry.FILE_ENTRY.PARENT_ENTRY_ID, FileEntry.FILE_ENTRY.FILENAME, FileEntry.FILE_ENTRY.ACTIVE_FLAG }, true);
